...
class DeviceController {
    ...
    public pl.web.app.client.Client findClient(@org.springframework.web.bind.annotation.PathVariable("clientId") int clientId) {
    ...
    public String processCreationForm(Client client, @Valid Device device, BindingResult result, ModelMap model) {
        if (StringUtils.hasLength(device.getName()) && device.isNew() && client.getDevice(device.getName(), true) != null) {
