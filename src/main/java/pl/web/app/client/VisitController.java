...
class VisitController {
	...
	public pl.web.app.visit.Visit loadDeviceWithVisit(
			@org.springframework.web.bind.annotation.PathVariable("deviceId") int deviceId,
	...
	// Spring MVC calls method loadDeviceWithVisit(...) before processNewVisitForm is
	// called
